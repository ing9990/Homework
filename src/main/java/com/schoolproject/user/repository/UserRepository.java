...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    void updatedUserName(Long userId, String userName, LocalDateTime update);
    ...
    @Query("select count(a) from User a, Authority b where a.school.schoolId=?1 and a.userId=b.userId and b.authority=?1")
